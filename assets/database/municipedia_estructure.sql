...
--
-- Estructura de tabla para la tabla `set_3`
--

DROP TABLE IF EXISTS `set_3`;
CREATE TABLE IF NOT EXISTS `set_3` (
  `link_1` int(4) DEFAULT NULL,
  `Nunca Asistio` int(5) DEFAULT NULL,
  `Inicial` int(5) DEFAULT NULL,
  `Primario incompleto` int(6) DEFAULT NULL,
  `Primario completo` int(6) DEFAULT NULL,
  `Secundario incompleto` int(6) DEFAULT NULL,
  `Secundario completo` int(6) DEFAULT NULL,
  `Terciario incompleto` int(5) DEFAULT NULL,
  `Terciario completo` int(5) DEFAULT NULL,
  `Universitario incompleto` int(6) DEFAULT NULL,
  `Universitario completo` int(5) DEFAULT NULL,
  `Postgrado universitario incompleto` int(4) DEFAULT NULL,
  `Postgrado universitario completo` int(4) DEFAULT NULL,
  `Educacion especial incompleto` int(4) DEFAULT NULL,
  `Educación especial completo` int(3) DEFAULT NULL,
  `Ignorado` int(5) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `set_4`
--

DROP TABLE IF EXISTS `set_4`;
CREATE TABLE IF NOT EXISTS `set_4` (
  `link_2` int(3) DEFAULT NULL,
  `1869 total` varchar(5) DEFAULT NULL,
  `1869 hombres` varchar(4) DEFAULT NULL,
  `1869 mujeres` varchar(4) DEFAULT NULL,
  `1881 total` varchar(5) DEFAULT NULL,
  `1881 hombres` varchar(5) DEFAULT NULL,
  `1881 mujeres` varchar(4) DEFAULT NULL,
  `1895 total` varchar(5) DEFAULT NULL,
  `1895 hombres` varchar(5) DEFAULT NULL,
  `1895 mujeres` varchar(5) DEFAULT NULL,
  `1914 total` varchar(6) DEFAULT NULL,
  `1914 hombres` varchar(5) DEFAULT NULL,
  `1914 mujeres` varchar(5) DEFAULT NULL,
  `1947 total` varchar(6) DEFAULT NULL,
  `1947 homres` varchar(6) DEFAULT NULL,
  `1947 mujeres` varchar(6) DEFAULT NULL,
  `1960 total` varchar(6) DEFAULT NULL,
  `1960 hombres` varchar(6) DEFAULT NULL,
  `1960 mujeres` varchar(6) DEFAULT NULL,
  `1970 total` varchar(6) DEFAULT NULL,
  `1970 hombres` varchar(6) DEFAULT NULL,
  `1970 mujeres` varchar(6) DEFAULT NULL,
  `1980 total` varchar(6) DEFAULT NULL,
  `1980 hombres` varchar(6) DEFAULT NULL,
  `1980 mujeres` varchar(6) DEFAULT NULL,
  `1991 total` varchar(7) DEFAULT NULL,
  `1991 hombres` varchar(6) DEFAULT NULL,
  `1991 mujeres` varchar(6) DEFAULT NULL,
  `2001 total` varchar(7) DEFAULT NULL,
  `2001 hombres` varchar(6) DEFAULT NULL,
  `2001 mujeres` varchar(6) DEFAULT NULL,
  `2010 total` varchar(7) DEFAULT NULL,
  `2010 hombres` varchar(6) DEFAULT NULL,
  `2010 mujeres` varchar(6) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `set_20130925195905`
--

DROP TABLE IF EXISTS `set_20130925195905`;
CREATE TABLE IF NOT EXISTS `set_20130925195905` (
  `link_0` int(11) NOT NULL,
  `Distancia a Cordoba capital` varchar(90) DEFAULT NULL,
  UNIQUE KEY `link_0` (`link_0`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `set_20130929163880`
--

DROP TABLE IF EXISTS `set_20130929163880`;
CREATE TABLE IF NOT EXISTS `set_20130929163880` (
  `link_0` int(11) NOT NULL,
  `Poblacion 1887` varchar(90) DEFAULT NULL,
  UNIQUE KEY `link_0` (`link_0`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
